...
<div>
<h2><?php echo JText::_('COM_COT_FORMS_TITLE_LIST_VIEW_SC_ADMINS'); ?></h2>
</div>
<div class="items">
    <ul class="items_list">
<?php $show = false; ?>
        <?php foreach ($this->items as $item) : ?>
				...
				<?php
						...
						?>
							<li>
								<a href="<?php echo JRoute::_('index.php?option=com_cot_forms&view=sc_admin&id=' . (int)$item->id); ?>">
									<?php echo $item->id; ?> - <?php echo $item->observation_date; ?> <?php echo JText::_('COM_COT_FORMS_OBSERVER_ITEM'); ?> <?php echo $item->observer_name; ?>
										...
										<form id="form-sc-admin-delete-<?php echo $item->id; ?>" style="display:inline" action="<?php echo JRoute::_('index.php?option=com_cot_forms&task=sc_admin.remove'); ?>" method="post" class="form-validate" enctype="multipart/form-data">
...
<?php endif; ?>
	...
	<a href="<?php echo JRoute::_('index.php?option=com_cot_forms&task=sc_admin.edit&id=0'); ?>">
		<?php echo JText::_("COM_COT_FORMS_ADD_ITEM"); ?></a>
&nbsp;
<?php if ($show): ?>
	<a href="<?php echo JRoute::_('index.php?option=com_cot_forms&task=sc_admins.export'); ?>">
