...
<script type="text/javascript">
    ...
    getScript('//ajax.googleapis.com/ajax/libs/jquery/1.9.1/jquery.min.js',function() {
        ...
        js(document).ready(function(){
            js('#form-sc_admin').submit(function(event){
...
<div class="sc_admin-edit front-end-edit">
    <?php if (!empty($this->item->id)): ?>
        <h1><?php echo JText::_('COM_COT_FORMS_SC_EDIT_ITEM_TITLE'); ?> <?php echo $this->item->id; ?></h1>
    <?php else: ?>
        <h1><?php echo JText::_('COM_COT_FORMS_SC_ADMIN_ADD_ITEM_TITLE'); ?></h1>
    <?php endif; ?>

    <form id="form-sc_admin" action="<?php echo JRoute::_('index.php?option=com_cot_forms&task=sc_admin.save'); ?>" method="post" class="form-validate" enctype="multipart/form-data">
        <ul>
        ...
        <div>
            ...
            <?php echo JText::_('or'); ?>
            <a href="<?php echo JRoute::_('index.php?option=com_cot_forms&task=sc_adminform.cancel'); ?>" title="<?php echo JText::_('JCANCEL'); ?>"><?php echo JText::_('JCANCEL'); ?></a>

            <input type="hidden" name="option" value="com_cot_forms" />
            <input type="hidden" name="task" value="sc_adminform.save" />
