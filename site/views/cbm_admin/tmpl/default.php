...
<?php if ($this->item) : ?>
    ...
    <div class="item_fields">
        ...
        <ul class="fields_list">
            		...
            		<li><span class="fields_ttl"><?php echo JText::_('COM_COT_FORMS_FORM_LBL_CBM_ADMIN_ID'); ?>:</span>
			...
			<li><span class="fields_lbl"><?php echo JText::_('COM_COT_FORMS_FORM_LBL_ADMIN_OBSERVERS_NAME'); ?>:</span>
	...
	<a href="<?php echo JRoute::_('index.php?option=com_cot_forms&task=cbm_admin.edit&id='.$this->item->id); ?>"><?php echo JText::_("COM_COT_FORMS_EDIT_ITEM"); ?></a>

								
									<a href="javascript:document.getElementById('form-cbm-admin-delete-<?php echo $this->item->id ?>').submit()"><?php echo JText::_("COM_COT_FORMS_DELETE_ITEM"); ?></a>
									<form id="form-cbm-admin-delete-<?php echo $this->item->id; ?>" style="display:inline" action="<?php echo JRoute::_('index.php?option=com_cot_forms&task=cbm-admin.remove'); ?>" method="post" class="form-validate" enctype="multipart/form-data">
										<input type="hidden" name="jform[id]" value="<?php echo $this->item->id; ?>" />
										<input type="hidden" name="option" value="com_cot_forms" />
										<input type="hidden" name="task" value="cbm_admin.remove" />
