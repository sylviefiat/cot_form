...
<div>
<h2><?php echo JText::_('COM_COT_FORMS_TITLE_LIST_VIEW_COT_ADMINS'); ?></h2>
</div>
<div class="items">
    <ul class="items_list">
<?php $show = false; ?>
				...
				<?php
						...
						?>
							<li>
								...
								- <?php echo $item->observation_date; ?> <?php echo JText::_('COM_COT_FORMS_OBSERVER_ITEM'); ?> <?php echo $item->observer_name; ?> 
										...
										- <a href="javascript:validateItem(<?php echo $item->id; ?>);"><?php echo JText::_("COM_COT_FORMS_VALIDATE_ITEM"); ?></a>
...
<?php endif; ?>
	...
	<a href="<?php echo JRoute::_('index.php?option=com_cot_forms&task=cot_admin.edit&id=0'); ?>">
		<?php echo JText::_("COM_COT_FORMS_ADD_ITEM"); ?></a>
&nbsp;
<?php if ($show): ?>
	<a href="<?php echo JRoute::_('index.php?option=com_cot_forms&task=cot_admins.export'); ?>">
