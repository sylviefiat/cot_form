...
<?php if ($this->item) : ?>
    ...
    <div class="item_fields">
        ...
        <ul class="fields_list">
            		...
            		<li><span class="fields_ttl"><?php echo JText::_('COM_COT_FORMS_FORM_LBL_HABITAT_ADMIN_ID'); ?>:</span>
			...
			<li><span class="fields_lbl"><?php echo JText::_('COM_COT_FORMS_FORM_LBL_HABITAT_ADMIN_STATE'); ?>:</span>
			<span class="fields_dsc"><?php echo $this->item->observation_state; ?></span></li>
        </ul>

    </div>
    
	<a href="<?php echo JRoute::_('index.php?option=com_cot_forms&task=habitat_admin.edit&id='.$this->item->id); ?>"><?php echo JText::_("COM_COT_FORMS_EDIT_ITEM"); ?></a>

								
									<a href="javascript:document.getElementById('form-habitat-admin-delete-<?php echo $this->item->id ?>').submit()"><?php echo JText::_("COM_COT_FORMS_DELETE_ITEM"); ?></a>
									<form id="form-habitat-admin-delete-<?php echo $this->item->id; ?>" style="display:inline" action="<?php echo JRoute::_('index.php?option=com_cot_forms&task=habitat-admin.remove'); ?>" method="post" class="form-validate" enctype="multipart/form-data">
										<input type="hidden" name="jform[id]" value="<?php echo $this->item->id; ?>" />
										<input type="hidden" name="option" value="com_cot_forms" />
										<input type="hidden" name="task" value="habitat_admin.remove" />
