...
<?php if ($this->item) : ?>
    ...
    <div class="item_fields">
        ...
        <ul class="fields_list">
            		...
            		<li><span class="fields_ttl"><?php echo JText::_('COM_COT_FORMS_FORM_LBL_AQUACULTURE_ADMIN_ID'); ?>:</span>
	...
	<a href="<?php echo JRoute::_('index.php?option=com_cot_forms&task=aquaculture_admin.edit&id='.$this->item->id); ?>"><?php echo JText::_("COM_COT_FORMS_EDIT_ITEM"); ?></a>

								
									<a href="javascript:document.getElementById('form-aquaculture-admin-delete-<?php echo $this->item->id ?>').submit()"><?php echo JText::_("COM_COT_FORMS_DELETE_ITEM"); ?></a>
									<form id="form-aquaculture-admin-delete-<?php echo $this->item->id; ?>" style="display:inline" action="<?php echo JRoute::_('index.php?option=com_cot_forms&task=aquaculture-admin.remove'); ?>" method="post" class="form-validate" enctype="multipart/form-data">
