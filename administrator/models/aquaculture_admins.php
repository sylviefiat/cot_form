...
/**
 * Methods supporting a list of Aquaculture_Admin records.
 */
class Cot_formsModelAquaculture_admins extends JModelList {
    ...
    public function __construct($config = array()) {
		...
		'observation_location', 'a.observation_location',
                ...
                'observation_target', 'a.observation_target',
                'observation_method', 'a.observation_method',
                'observation_results', 'a.observation_results',
    ...
    protected function getListQuery() {
        ...
        $query->from('`#__aquaculture_admin` AS a');
