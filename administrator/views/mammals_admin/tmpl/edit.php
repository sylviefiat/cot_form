...
<script type="text/javascript">
    ...
    {
        if (task == 'mammals_admin.cancel') {
            Joomla.submitform(task, document.getElementById('mammals_admin-form'));
        }
        else {
            
            if (task != 'mammals_admin.cancel' && document.formvalidator.isValid(document.id('mammals_admin-form'))) {
...
<form action="<?php echo JRoute::_('index.php?option=com_cot_forms&layout=edit&id=' . (int) $this->item->id); ?>" method="post" enctype="multipart/form-data" name="adminForm" id="mammals_admin-form" class="form-validate">

    <div class="form-horizontal">
        <?php echo JHtml::_('bootstrap.startTabSet', 'myTab', array('active' => 'general')); ?>

        <?php echo JHtml::_('bootstrap.addTab', 'myTab', 'general', JText::_('COM_COT_FORMS_TITLE_MAMMALS_ADMIN', true)); ?>
        <div class="row-fluid">
