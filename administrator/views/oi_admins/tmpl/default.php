...
if ($saveOrder)
{
	$saveOrderingUrl = 'index.php?option=com_cot_forms&task=oi_admins.saveOrderAjax&tmpl=component';
	JHtml::_('sortablelist.sortable', 'oi_adminList', 'adminForm', strtolower($listDirn), $saveOrderingUrl);
}
...
<form action="<?php echo JRoute::_('index.php?option=com_cot_forms&view=oi_admins'); ?>" method="post" name="adminForm" id="adminForm">
...
<?php endif;?>
		...
		<table class="table table-striped" id="oi_adminList">
			<thead>
				<tr>
			...
			<?php foreach ($this->items as $i => $item) :
                ...
                <?php if (isset($this->items[0]->state)): ?>
					<td class="center">
						<?php echo JHtml::_('jgrid.published', $item->state, $i, 'oi_admins.', $canChange, 'cb'); ?>
					</td>
                <?php endif; ?>
                    
				<td>
				<?php if (isset($item->checked_out) && $item->checked_out) : ?>
					<?php echo JHtml::_('jgrid.checkedout', $i, $item->editor, $item->checked_out_time, 'oi_admins.', $canCheckin); ?>
				<?php endif; ?>
				<?php if ($canEdit) : ?>
					<a href="<?php echo JRoute::_('index.php?option=com_cot_forms&task=oi_admin.edit&id='.(int) $item->id); ?>">
