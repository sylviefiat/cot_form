...
if ($saveOrder)
{
	$saveOrderingUrl = 'index.php?option=com_cot_forms&task=sc_admins.saveOrderAjax&tmpl=component';
	JHtml::_('sortablelist.sortable', 'sc_adminList', 'adminForm', strtolower($listDirn), $saveOrderingUrl);
}
...
<form action="<?php echo JRoute::_('index.php?option=com_cot_forms&view=sc_admins'); ?>" method="post" name="adminForm" id="adminForm">
...
<?php endif;?>
		...
		<table class="table table-striped" id="sc_adminList">
			<thead>
				<tr>
			...
			<?php foreach ($this->items as $i => $item) :
				...
				<?php endif; ?>
				<?php if ($canEdit) : ?>
					<a href="<?php echo JRoute::_('index.php?option=com_cot_forms&task=sc_admin.edit&id='.(int) $item->id); ?>">
