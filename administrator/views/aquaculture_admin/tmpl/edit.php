...
<script type="text/javascript">
    ...
    {
        if (task == 'aquaculture_admin.cancel') {
            Joomla.submitform(task, document.getElementById('aquaculture_admin-form'));
        }
        else {
            
            if (task != 'aquaculture_admin.cancel' && document.formvalidator.isValid(document.id('aquaculture_admin-form'))) {
...
<form action="<?php echo JRoute::_('index.php?option=com_cot_forms&layout=edit&id=' . (int) $this->item->id); ?>" method="post" enctype="multipart/form-data" name="adminForm" id="aquaculture_admin-form" class="form-validate">

    <div class="form-horizontal">
        <?php echo JHtml::_('bootstrap.startTabSet', 'myTab', array('active' => 'general')); ?>

        <?php echo JHtml::_('bootstrap.addTab', 'myTab', 'general', JText::_('COM_COT_FORMS_TITLE_AQUACULTURE_ADMIN', true)); ?>
        <div class="row-fluid">
