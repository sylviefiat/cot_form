...
<script type="text/javascript">
    ...
    {
        if (task == 'sc_admin.cancel') {
            Joomla.submitform(task, document.getElementById('sc_admin-form'));
        }
        else {
            
            if (task != 'sc_admin.cancel' && document.formvalidator.isValid(document.id('sc_admin-form'))) {
...
<form action="<?php echo JRoute::_('index.php?option=com_cot_forms&layout=edit&id=' . (int) $this->item->id); ?>" method="post" enctype="multipart/form-data" name="adminForm" id="sc_admin-form" class="form-validate">

    <div class="form-horizontal">
        <?php echo JHtml::_('bootstrap.startTabSet', 'myTab', array('active' => 'general')); ?>

        <?php echo JHtml::_('bootstrap.addTab', 'myTab', 'general', JText::_('COM_COT_FORMS_TITLE_SC_ADMIN', true)); ?>
        <div class="row-fluid">
