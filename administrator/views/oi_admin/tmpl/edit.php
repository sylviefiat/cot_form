...
<script type="text/javascript">
    ...
    {
        if (task == 'oi_admin.cancel') {
            Joomla.submitform(task, document.getElementById('oi_admin-form'));
        }
        else {
            
            if (task != 'oi_admin.cancel' && document.formvalidator.isValid(document.id('oi_admin-form'))) {
...
<form action="<?php echo JRoute::_('index.php?option=com_cot_forms&layout=edit&id=' . (int) $this->item->id); ?>" method="post" enctype="multipart/form-data" name="adminForm" id="oi_admin-form" class="form-validate">

    <div class="form-horizontal">
        <?php echo JHtml::_('bootstrap.startTabSet', 'myTab', array('active' => 'general')); ?>

        <?php echo JHtml::_('bootstrap.addTab', 'myTab', 'general', JText::_('COM_COT_FORMS_TITLE_OI_ADMIN', true)); ?>
        <div class="row-fluid">
